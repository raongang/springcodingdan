			...
			<div class="box">
				...
				<div class="box-body">
					...
					<select name="searchType">
						...
						<option value="cw" <c:out value="${cri.searchType eq 'cw'?'selected':'' }" />>CONTENT OR WRTIER</option>
						<option value="tcw" <c:out value="${cri.searchType eq 'tcw'?'selected':'' }" />>TITLE OR CONTENT OR WRTIER</option>
					</select>
					...
					<div class="text-center">
						...
						<ul class="pagination">
							...
							<!-- 
							 ...
							 -->																	
							 	<li><a href="list${pageMaker.makeSearch(pageMaker.startPage-1)}">&raquo;</a></li>
							</c:if>
